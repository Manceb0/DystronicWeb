    ...
    return (
        <div className="container mx-auto px-4 py-12">
            <div className="mb-12 border-b border-white/5 pb-8 relative">
                ...
                <h1 className="text-4xl font-bold font-mono uppercase tracking-widest text-white mb-4">Learning Paths</h1>
                <p className="text-gray-400 font-mono max-w-2xl text-sm leading-relaxed">
                    Upgrade your skills from basic wiring to advanced IoT architecture. Each course has a final project linked to our physical kits.
                </p>
            </div>
                    ...
                    <div key={course.id} className="glass-panel flex flex-col group overflow-hidden border-t-2 border-t-transparent hover:border-t-[#ffcc00]">
                        ...
                        <div className="p-6 flex flex-col flex-1">
                            ...
                            <div className="mb-6 flex-1">
                                <p className="text-xs text-gray-500 font-mono uppercase tracking-widest mb-2">Final Project:</p>
                            ...
                            <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5">
                                ...
                                <Link href={`/courses/${course.id}`}>
                                    <Button variant="outline" size="sm">Syllabus <ArrowRight size={14} className="ml-2" /></Button>
                                </Link>
                            </div>
                        </div>
                    </div>
