...
export const MOCK_COMPONENTS: Part[] = [
  // Microcontrollers
  { id: "c1", name: "Arduino Uno R3", category: "microcontroller", price: 25.00, stock: 150, tags: ["Beginner", "Robotics"], image: "/mock/arduino.png", description: "Classic microcontroller board based on the ATmega328P.", specs: { "Microcontroller": "ATmega328P", "Operating Voltage": "5V" } },
  ...
  { id: "c3", name: "Raspberry Pi Pico", category: "microcontroller", price: 6.00, stock: 200, tags: ["Beginner", "Python"], image: "/mock/pico.png", description: "RP2040 chip designed by Raspberry Pi.", specs: { "Processor": "Dual-core ARM Cortex M0+", "SRAM": "264KB" } },
  ...
  // Sensors
  { id: "c5", name: "HC-SR04 Ultrasonic Sensor", category: "sensor", price: 3.50, stock: 500, tags: ["Beginner", "Robotics"], image: "/mock/hc-sr04.png", description: "Ultrasonic ranging module 2cm-400cm.", specs: { "Voltage": "5V", "Ranging Distance": "2cm - 400cm" } },
  ...
  // Motors & Actuators
  { id: "c11", name: "SG90 Micro Servo", category: "motor", price: 4.00, stock: 800, tags: ["Beginner", "Robotics"], image: "/mock/sg90.png", description: "Tiny and lightweight servo motor with high output power.", specs: { "Torque": "1.8 kg-cm", "Speed": "0.1 s/60°" } },
